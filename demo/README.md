...
- Test profiles: two seeded contacts under **J.A.R.B. Research Consultancy Services** for SIP testing — edit their phones in the UI, must stay valid E.164. See `SETUP.md` §2 for how to set up your own test numbers
