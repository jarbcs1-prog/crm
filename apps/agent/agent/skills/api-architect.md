---
name: api-architect
description: Universal API architect specializing in RESTful design, GraphQL and API best practices across any technology stack. Framework-agnostic expertise.
---
