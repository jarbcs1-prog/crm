...
async function main() {
	...
	try {
		...
		if (recording.length > 0) {
			console.log(
				"Heard something! Recording size:",
				recording.length,
				"bytes",
			);
			// Try to transcribe
