...
-- Companies
\copy crm_legacy.companies FROM 'F:/crm/crm_extracted/crm_table_companies.csv' WITH (FORMAT csv, HEADER true);

-- Clients (multiline quoted notes handled by CSV parser)
\copy crm_legacy.clients FROM 'F:/crm/crm_extracted/crm_table_clients.csv' WITH (FORMAT csv, HEADER true);

-- Users
\copy crm_legacy.users FROM 'F:/crm/crm_extracted/crm_table_users.csv' WITH (FORMAT csv, HEADER true);

-- Groups
\copy crm_legacy.groups FROM 'F:/crm/crm_extracted/crm_table_groups.csv' WITH (FORMAT csv, HEADER true);

-- Statuses
\copy crm_legacy.statuses FROM 'F:/crm/crm_extracted/crm_table_statuses.csv' WITH (FORMAT csv, HEADER true);

-- Phone types
\copy crm_legacy.phone_types FROM 'F:/crm/crm_extracted/crm_table_phone_types.csv' WITH (FORMAT csv, HEADER true);

-- Countries
\copy crm_legacy.countries FROM 'F:/crm/crm_extracted/crm_table_countries.csv' WITH (FORMAT csv, HEADER true);

-- Lists
\copy crm_legacy.lists FROM 'F:/crm/crm_extracted/crm_table_lists.csv' WITH (FORMAT csv, HEADER true);

-- Positions
\copy crm_legacy.positions FROM 'F:/crm/crm_extracted/crm_table_positions.csv' WITH (FORMAT csv, HEADER true);

-- Stocks
\copy crm_legacy.stocks FROM 'F:/crm/crm_extracted/crm_table_stocks.csv' WITH (FORMAT csv, HEADER true);

-- Company employees
\copy crm_legacy.company_employees FROM 'F:/crm/crm_extracted/crm_table_company_employees.csv' WITH (FORMAT csv, HEADER true);

-- Group permissions (can_send_to_status is text due to comma-separated values)
\copy crm_legacy.group_permissions FROM 'F:/crm/crm_extracted/crm_table_group_permissions.csv' WITH (FORMAT csv, HEADER true);

-- Call campaigns (only header row in source file)
\copy crm_legacy.call_campaigns FROM 'F:/crm/crm_extracted/crm_table_call_campaigns.csv' WITH (FORMAT csv, HEADER true);

-- Call log
\copy crm_legacy.call_log FROM 'F:/crm/crm_extracted/crm_table_call_log_fixed.csv' WITH (FORMAT csv, HEADER true);

-- DNC list (only header row in source file)
\copy crm_legacy.dnc_list FROM 'F:/crm/crm_extracted/crm_table_dnc_list.csv' WITH (FORMAT csv, HEADER true);

-- Refs
\copy crm_legacy.refs FROM 'F:/crm/crm_extracted/crm_table_refs.csv' WITH (FORMAT csv, HEADER true);

-- Trunks
\copy crm_legacy.trunks FROM 'F:/crm/crm_extracted/crm_table_trunks.csv' WITH (FORMAT csv, HEADER true);

-- Client audit
\copy crm_legacy.client_audit FROM 'F:/crm/crm_extracted/crm_table_client_audit.csv' WITH (FORMAT csv, HEADER true);

-- Client contacts
\copy crm_legacy.client_contacts FROM 'F:/crm/crm_extracted/crm_table_client_contacts.csv' WITH (FORMAT csv, HEADER true);

-- Client notes
\copy crm_legacy.client_notes FROM 'F:/crm/crm_extracted/crm_table_client_notes.csv' WITH (FORMAT csv, HEADER true);

-- Client shares
\copy crm_legacy.client_shares FROM 'F:/crm/crm_extracted/crm_table_client_shares.csv' WITH (FORMAT csv, HEADER true);
